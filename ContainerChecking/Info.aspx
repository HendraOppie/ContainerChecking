<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Info.aspx.vb" Inherits="ContainerChecking.Info1" %>
        ...
        <div id="divHead" runat="server" style="width:300px; font-family:Calibri" >
            <asp:Table runat="server" Width="300px" >
                <asp:TableRow VerticalAlign="Middle">
                    ...
                    <asp:TableCell>
                        <asp:Label runat="server" Text="Container Checking" Font-Bold="true" ForeColor="DarkSlateBlue" Font-Size="18px"></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
            <br />
            <asp:Panel runat="server" Width="100%" HorizontalAlign="Center" >
                <asp:Label ID="Label1" runat="server" Text=".:: Information ::." Font-Bold="True" Font-Size="Large" ForeColor="DarkSlateBlue"></asp:Label>
