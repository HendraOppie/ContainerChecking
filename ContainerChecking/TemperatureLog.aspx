<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/masterMain.Master" CodeBehind="TemperatureLog.aspx.vb" Inherits="ContainerChecking.TemperatureLog" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <asp:Label runat="server" Font-Names="Calibri" Font-Size="Larger" Font-Bold="true" Text="Temperature Log" ForeColor="DarkBlue" /><br /><br />
    ...
    <div id="divDatagrid" runat="server" style="font-family:Calibri;font-size:14px;Height:730px;width:1700px;overflow:auto">
        <asp:Table ID="tblDetail" runat="server" GridLines="Both" CellPadding="5" >
            <asp:TableHeaderRow HorizontalAlign="Left"  BackColor="LightGray">
                ...
                <asp:TableHeaderCell Text="Set Temperature" />
                <asp:TableHeaderCell Text="Temperature" />
                <asp:TableHeaderCell Text="Battery" />
            ...
            <asp:TableHeaderRow HorizontalAlign="Left" CssClass="rowHeaderFilter">
                ...
                <asp:TableHeaderCell><asp:TextBox ID="tbContainerSearch" runat="server" /></asp:TableHeaderCell>
                <asp:TableHeaderCell><asp:DropDownList ID="ddLocationSearch" runat="server" /></asp:TableHeaderCell>
                <asp:TableHeaderCell><asp:TextBox ID="tbSetTemperature" runat="server" Width="80px" /></asp:TableHeaderCell>
                <asp:TableHeaderCell><asp:TextBox ID="tbTemperature" runat="server" Width="80px" /></asp:TableHeaderCell>
                <asp:TableHeaderCell><asp:TextBox ID="tbBattery" runat="server" Width="80px" /></asp:TableHeaderCell>
                ...
                <asp:TableHeaderCell><asp:Label runat="server" /></asp:TableHeaderCell>
            </asp:TableHeaderRow>
        </asp:Table>
